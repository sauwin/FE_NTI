...
<template>
  ...
  <PageHero
      badge="Partners"
      title="Our Strategical"
      highlight="Partners"
      description="Our project is made possible through the support of dedicated organizations and individuals who share our vision and help us create meaningful opportunities for participants."
  />

  <section class="max-w-6xl mx-auto px-6 py-16">
    <div v-if="loading" class="text-center text-slate-400 py-20">Loading...</div>

    <div v-else-if="error" class="text-center text-red-400 py-20">Failed to load partners.</div>

    <div v-else-if="partners.length === 0" class="text-center text-slate-500 py-20">No partners yet.</div>
